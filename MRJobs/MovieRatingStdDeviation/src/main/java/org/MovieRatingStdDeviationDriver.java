...
public class MovieRatingStdDeviationDriver {
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        Job job = new Job(conf, "Movie_Rating_Standard_Deviation");
        job.setJarByClass(MovieRatingStdDeviationDriver.class);
        job.setMapperClass(MovieRatingStdDeviationMapper.class);
        job.setReducerClass(MovieRatingStdDeviationReducer.class);
