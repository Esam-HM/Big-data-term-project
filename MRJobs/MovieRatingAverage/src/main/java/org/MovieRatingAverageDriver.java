...
public class MovieRatingAverageDriver {
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        Job job = new Job(conf, "MovieRatingAverage");
        job.setJarByClass(MovieRatingAverageDriver.class);
        job.setMapperClass(MovieRatingAverageMapper.class);
        job.setReducerClass(MovieRatingAverageReducer.class);
