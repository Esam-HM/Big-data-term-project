...
public class MovieSkewnessRatingDriver {
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        Job job = new Job(conf, "Movie_Rating_Skewness");
        job.setJarByClass(MovieSkewnessRatingDriver.class);
        job.setMapperClass(MovieSkewnessRatingMapper.class);
        job.setReducerClass(MovieSkewnessRatingReducer.class);
